  ...
  promisify = function(a) {
    return function(b) {
      ...
      return new Promise(function(f, g) {
        a.apply(void 0, [Object.assign({}, b, {
          success: f,
          fail: g
        })].concat(d)), Promise.prototype.finally = function(h) {
          var j = this.constructor;
          return this.then(function(k) {
            return j.resolve(h()).then(function() {
              return k
            })
          }, function(k) {
            return j.resolve(h()).then(function() {
...
var wxPromise = function() {
  for (var a in wx) wx.hasOwnProperty(a) && (wx.pro[a] = /^on|^create|Sync$|Manager$|^pause/.test(a) && 'createBLEConnection' != a || 'stopRecord' == a || 'stopVoice' == a || 'stopBackgroundAudio' == a || 'stopPullDownRefresh' == a || 'hideKeyboard' == a || 'hideToast' == a || 'hideLoading' == a || 'showNavigationBarLoading' == a || 'hideNavigationBarLoading' == a || 'canIUse' == a || 'navigateBack' == a || 'closeSocket' == a || 'closeSocket' == a || 'pageScrollTo' == a || 'drawCanvas' == a ? wx[a] : promisify(wx[a]));
  wx.pro.match = function(a, b) {
    var c = '';
    return 'chinese' === a ? c = /[\u4e00-\u9fa5]/gm : 'email' === a ? c = /\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*/ : 'url' === a ? c = /^https?:\/\/(([a-zA-Z0-9_-])+(\.)?)*(:\d+)?(\/((\.)?(\?)?=?&?[a-zA-Z0-9_-](\?)?)*)*$/i : 'phoneNumber' === a ? c = /^(0|86|17951)?(13[0-9]|14[579]|15[012356789]|16[56]|17[1235678]|18[0-9]|19[89])\s{0,1}[0-9]{4}\s{0,1}[0-9]{4}$/ : 'cardid' === a ? c = /^(^[1-9]\d{7}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{3}$)|(^[1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])((\d{4})|\d{3}[Xx])$)$/ : 'mail' === a && (c = /^[1-9]\d{5}(?!\d)$/), !!c.test(b)
  }, wx.pro.showTopTips = function(a, b) {
    return new Promise(function(c, d) {
      a || d('\u7F3A\u5C11\u914D\u7F6E\u9879\uFF01'), a.content || d('option.content\u5C5E\u6027\u662F\u5FC5\u987B\u7684');
      var e = b.data.topTips || {};
      e.timeout && (clearTimeout(e.timeout), e.timeout = 0), a.duration === void 0 && (a.duration = 3e3);
  ...
  }, wx.pro.initChart = function(a, b) {
    return function(c, d, e) {
      var f = b.init(c, null, {
        width: d,
        height: e
      });
      return c.setChart(f), f.setOption(a), f
    }
  }, wx.pro.lazyInitChart = function(a, b, c, d) {
    return new Promise(function(e) {
      d.selectComponent(c).init(function(k, l, m) {
        var n = b.init(k, null, {
          width: l,
          height: m
        });
        n.setOption(a), d.chart = n, e(n)
      })
    })
  }, wx.pro.updateChart = function(a, b) {
    a.clear(), a.setOption(b)
  }, wx.pro.saveImageToPhotosAlbum = function(a) {
    return new Promise(function(b, c) {
      wx.getSetting({
        success: function success(d) {
          d.authSetting['scope.writePhotosAlbum'] ? wx.saveImageToPhotosAlbum({
            filePath: a,
  ...
  }, wx.pro.canvasToTempFilePath = function(a) {
    return new Promise(function(b, c) {
      a.draw(!0, function() {
...
wxPromise(), ! function(a) {
  ...
  function h(I) {
    function J(M, N, O, Q) {
      var R = c(I[M], I, N);
      if ('throw' === R.type) Q(R.arg);
      else {
        var S = R.arg,
          T = S.value;
        return T && 'object' === ('undefined' == typeof T ? 'undefined' : _typeof(T)) && r.call(T, '__await') ? Promise.resolve(T.__await).then(function(U) {
          J('next', U, O, Q)
        }, function(U) {
          J('throw', U, O, Q)
  ...
  function j(I, J, K) {
    ...
    return function(N, O) {
      ...
      for (K.method = N, K.arg = O;;) {
        ...
        if ('next' === K.method) K.sent = K._sent = K.arg;
        else if ('throw' === K.method) {
        ...
        var S = c(I, J, K);
        if ('normal' === S.type) {
          if (L = K.done ? C : A, S.arg === D) continue;
          return {
            value: S.arg,
            done: K.done
          }
        }
        'throw' === S.type && (L = C, K.method = 'throw', K.arg = S.arg)
      }
    }
  }
  ...
  function k(I, J) {
    ...
    if (M.done) J[I.resultName] = M.value, J.next = I.nextLoc, 'return' !== J.method && (J.method = 'next', J.arg = s);
    else return M;
  ...
  var q = Object.prototype,
    r = q.hasOwnProperty,
    s, t = 'function' == typeof Symbol ? Symbol : {},
    u = t.iterator || '@@iterator',
    v = t.asyncIterator || '@@asyncIterator',
    w = t.toStringTag || '@@toStringTag',
    x = 'object' === ('undefined' == typeof module ? 'undefined' : _typeof(module)),
  ...
  e.prototype = H.constructor = f, f.constructor = e, f[w] = e.displayName = 'GeneratorFunction', y.isGeneratorFunction = function(I) {
    ...
    reset: function reset(I) {
      if (this.prev = 0, this.next = 0, this.sent = this._sent = s, this.done = !1, this.delegate = null, this.method = 'next', this.arg = s, this.tryEntries.forEach(m), !I)
        for (var J in this) 't' === J.charAt(0) && r.call(this, J) && !isNaN(+J.slice(1)) && (this[J] = s)
    },
    stop: function stop() {
      this.done = !0;
    ...
    dispatchException: function dispatchException(I) {
      function J(R, S) {
        return N.type = 'throw', N.arg = I, K.next = R, S && (K.method = 'next', K.arg = s), !!S
      }
      ...
      for (var K = this, L = this.tryEntries.length - 1; 0 <= L; --L) {
        ...
        if (M.tryLoc <= this.prev) {
          var O = r.call(M, 'catchLoc'),
            Q = r.call(M, 'finallyLoc');
          if (O && Q) {
            if (this.prev < M.catchLoc) return J(M.catchLoc, !0);
            if (this.prev < M.finallyLoc) return J(M.finallyLoc)
          } else if (O) {
            if (this.prev < M.catchLoc) return J(M.catchLoc, !0);
          } else if (!Q) throw new Error('try statement without catch or finally');
          else if (this.prev < M.finallyLoc) return J(M.finallyLoc)
        }
      }
    },
